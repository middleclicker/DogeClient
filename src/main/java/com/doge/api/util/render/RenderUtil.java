package com.doge.api.util.render;
...
public class RenderUtil implements Global {
    ...
    public static void drawBox(BlockPos blockPos, double height, DColor color, int sides) {
        drawBox(blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1, height, 1, color, color.getAlpha(), sides);
    }

    public static void drawBox(AxisAlignedBB bb, boolean check, double height, DColor color, int sides) {
        drawBox(bb, check, height, color, color.getAlpha(), sides);

    }

    public static void drawBox(AxisAlignedBB bb, boolean check, double height, DColor color, int alpha, int sides) {
        if (check) {
    ...
    public static void drawText(BlockPos pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double) Main.INSTANCE.cFontRenderer.getStringWidth(text) / 2.0), 0.0, 0.0);
        Main.INSTANCE.cFontRenderer.drawStringWithShadow(text, 0.0f, 0.0f, new DColor(255, 255, 255, 255));
        GlStateManager.popMatrix();
    }
    ...
    public static void drawBBBox(AxisAlignedBB BB, DColor colour, int alpha) {
    ...
    public static void drawBox(double x, double y, double z, double w, double h, double d, DColor color, int alpha, int sides) {
        GlStateManager.disableAlpha();
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        color.glColor();
    ...
    public static void drawBoundingBox(AxisAlignedBB bb, double width, DColor color, int alpha) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
    ...
    private static void colorVertex(double x, double y, double z, DColor color, int alpha, BufferBuilder bufferbuilder) {
    ...
    private static void doVerticies(AxisAlignedBB axisAlignedBB, DColor color, int alpha, BufferBuilder bufferbuilder, int sides, boolean five) {
    ...
    public static void drawBoundingBoxWithSides(BlockPos blockPos, int width, DColor color, int sides) {
        drawBoundingBoxWithSides(getBoundingBox(blockPos, 1, 1, 1), width, color, color.getAlpha(), sides);
    }

    public static void drawBoundingBoxWithSides(BlockPos blockPos, int width, DColor color, int alpha, int sides) {
        drawBoundingBoxWithSides(getBoundingBox(blockPos, 1, 1, 1), width, color, alpha, sides);
    }

    public static void drawBoundingBoxWithSides(AxisAlignedBB axisAlignedBB, int width, DColor color, int sides) {
        drawBoundingBoxWithSides(axisAlignedBB, width, color, color.getAlpha(), sides);
    }

    public static void drawBoundingBoxWithSides(AxisAlignedBB axisAlignedBB, int width, DColor color, int alpha, int sides) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
    ...
    public static void drawText(BlockPos pos, String text, boolean custom) {
        ...
        GlStateManager.translate(-((double)  Main.INSTANCE.cFontRenderer.getStringWidth(text) / 2.0), 0.0, 0.0);
        if (custom) {
            Main.INSTANCE.cFontRenderer.drawStringWithShadow(text, 0.0f, 0.0f, new DColor(0, 0, 0));
        } else {
    ...
    public static void drawCircle(float x, float y, float z, float radius, DColor colour){
    ...
    public static void drawColumn(float x, float y, float z, float radius, DColor colour, int amount, double height){
    ...
    public static void drawCircleVertices(AxisAlignedBB bb, float radius, DColor colour){
