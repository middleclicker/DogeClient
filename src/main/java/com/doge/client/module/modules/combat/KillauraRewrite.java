...
public class KillauraRewrite extends Module {
    ...
    public KillauraRewrite() {
        super("Kill Aura Rewrite", "Swings at enemies in a range.", Category.COMBAT);
            ...
            if (raytrace.isOn()) {
                ...
                if (!shouldWait()) {
                    ...
                    if (this.rotate.is("Camera")) {
                        ...
                        // TODO: Implement rotation setting for packet.
                    }
                }
            }
        }
    ...
    private double getMinHealth(List<Entity> loadedEntityList) {
        ...
        if (loadedEntityList.size() == 0) { return 37.0; }
    ...
    private double getMinDistance(List<Entity> loadedEntityList) {
        ...
        if (loadedEntityList.size() == 0) { return range.getNumber()+1; }
