...
public class ViewModel extends Module {
    ...
    public NumberSetting mainY = new NumberSetting("MainY", this, -0.63, -3.0, 3.0, 0.1);
    public NumberSetting mainZ = new NumberSetting("MainZ", this, -2.17, -5.0, 5.0, 0.1);
    public NumberSetting offX = new NumberSetting("OffX", this, -1.2, -6.0, 0.0, 0.1);
    public NumberSetting offY = new NumberSetting("OffY", this, -0.75, -3.0, 3.0, 0.1);
    public NumberSetting offZ = new NumberSetting("OffZ", this, -2.67, -5.0, 5.0, 0.1);
